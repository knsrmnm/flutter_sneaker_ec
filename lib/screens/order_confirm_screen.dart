...
import 'package:flutter_sneaker_ec/constants.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: _type == 1 ? Border.all(width: 1.0, color: Colors.black) : Border.all(width: 0.3, color: Colors.grey),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Radio(value: 1, groupValue: _type, onChanged: _handleRadio, activeColor: SnkConstants.kPrimaryColor),
                              Text(
                                'Amazon pay',
                                style: _type == 1 ? TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, color: Colors.black) : TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, color: Colors.grey)
                              ),
                            ],
                          ),
                          Image.asset("assets/icons/amazon-pay.png", width: 50.0),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Radio(value: 2, groupValue: _type, onChanged: _handleRadio, activeColor: SnkConstants.kPrimaryColor),
                              Text(
                                'Credit card',
                ...
                Container(
                  ...
                  height: 55.0,
                  decoration: BoxDecoration(
                    border: _type == 3 ? Border.all(width: 1.0, color: Colors.black) : Border.all(width: 0.3, color: Colors.grey),
                    borderRadius: BorderRadius.all(Radius.circular(5.0)),
                    color: Colors.transparent,
                  ),
                  child: Center(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Radio(value: 3, groupValue: _type, onChanged: _handleRadio, activeColor: SnkConstants.kPrimaryColor),
                              Text(
                                'Paypal',
                                  style: _type == 3 ? TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, color: Colors.black) : TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, color: Colors.grey)
                              ),
                            ],
                          ),
                          Image.asset("assets/icons/paypal.png", width: 50.0),
                        ],
                      ),
                    ),
                  ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text("Place order", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 15.0)),
                    )
                  ),
                ),
              ],
